...
ML models used to detect COVID-19 from chest x-rays focus on irrelevant features like annotations. This repository uses Pluralistic Image Inpainting to address this problem.

# Attribution

The repo modifies code from [https://github.com/lyndonzheng/Pluralistic-Inpainting](https://github.com/lyndonzheng/Pluralistic-Inpainting), a repo implementing  "Pluralistic Image Completion" by Chuanxia Zheng, Tat-Jen Cham and Jianfei Cai. This is test.py, train.py and the code in the folders (dataloader, evaluations, model, options, util).
...
* saliencymaps.py uses Backprop and Guided Backprop to interpret the ResNet model's predictions. The saliency code is written by Irina Malyugina using this toolkit: [https://github.com/MisaOgura/flashtorch](https://github.com/MisaOgura/flashtorch).
...
The code from [https://github.com/jacobgil/pytorch-grad-cam](https://github.com/jacobgil/pytorch-grad-cam) is licensed under and MIT license (see LICENSE file).
